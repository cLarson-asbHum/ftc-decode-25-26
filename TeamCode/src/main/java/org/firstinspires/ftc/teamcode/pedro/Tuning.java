...
public class Tuning extends SelectableOpMode {
    public static abstract class OpModeOption extends OpMode {
        @Override
        public void init() {
            if (follower == null) {
     ...
     */
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class LocalizationTest extends OpModeOption {
        @Override
        public void oninit() {}
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class ForwardTuner extends OpModeOption {
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class LateralTuner extends OpModeOption {
        public static double DISTANCE = 48;
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class TurnTuner extends OpModeOption {
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class ForwardVelocityTuner extends OpModeOption {
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class LateralVelocityTuner extends OpModeOption {
        private final ArrayList<Double> velocities = new ArrayList<>();
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class ForwardZeroPowerAccelerationTuner extends OpModeOption {
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class LateralZeroPowerAccelerationTuner extends OpModeOption {
        private final ArrayList<Double> accelerations = new ArrayList<>();
        public static double VELOCITY = 30;
        private double previousVelocity;
        private long previousTimeNano;
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class TranslationalTuner extends OpModeOption {
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class HeadingTuner extends OpModeOption {
        public static double DISTANCE = 40;
        private boolean forward = true;
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class DriveTuner extends OpModeOption {
        public static double DISTANCE = 40;
        private boolean forward = true;
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class Line extends OpModeOption {
        public static double DISTANCE = 40;
        private boolean forward = true;
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class CentripetalTuner extends OpModeOption {
     ...
     */
    @TeleOp(group="Pedro Pathing")
    public static class Triangle extends OpModeOption {
    ...
    @TeleOp(group="Pedro Pathing")
    @Configurable
    public static class Circle extends OpModeOption {
    ...
    public void onSelect() {
        // // NOTE: Moved these commented-out lines into a OpModeOption class so that the opmodes 
        //          can be run without using the Tuning opmode, similar to RoadRunner.
        // if (follower == null) {
        //     follower = Constants.createFollower(hardwareMap);
        //     PanelsConfigurables.INSTANCE.refreshClass(this);
        // } else {
        ...
        // Doing nothing, as SelectableOpmode already handles init. See note above for more details
    }
